...
scale = .6
#arcade.draw_texture_rectangle(540, 120, scale * texture.width, scale * texture.height, texture, 0)
#arcade.draw_texture_rectangle(540, 60, scale * texture.width, scale * texture.height, texture, 45)
