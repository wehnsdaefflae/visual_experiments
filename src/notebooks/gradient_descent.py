...
def gradient_descent(function_ext: Callable[[Sequence[float]], float], degree: int, no_arguments_function: int = 1):
    ...
    while True:
        ...
        if Timer.time_passed(2000):
            print(f"iteration: {iterations:d}\n"
                  ...
                  f"parameters: {', '.join([f'{_p:.2f}' for _p in parameters]):s}\n\n")
